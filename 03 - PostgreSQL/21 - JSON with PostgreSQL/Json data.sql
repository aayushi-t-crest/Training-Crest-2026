...
create index idx_gin_contacts_docs_body_cool1 on contacts_docs using gin(body jsonb_path_ops);

select pg_size_pretty(pg_relation_size('idx_gin_contacts_docs_body_cool1'::regclass)) as index_name

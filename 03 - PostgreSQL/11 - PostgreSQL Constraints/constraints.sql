...
insert into table_nn(tag) values ('vinay');
...
insert into employees(first_name, last_name) values ('Aayushi2', 'Trivedi2');
...
insert into table_items(item_id, item_name) values (2,'Eraser');
...
values ('Aayushi1', 'Trivedi1', '2004-05-01', '2020-10-02', 10000)

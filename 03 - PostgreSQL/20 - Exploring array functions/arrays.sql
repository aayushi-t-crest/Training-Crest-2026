...
select
	...
	numrange(4.6, 8.2) && numrange(2, 4.7)
...
select
	array_ndims(array[[1],[2],[5]]) as "Dimensions"
...
select
	array_length(array[2,3,4],1)

select
	array_length(array[3,4], 1)
...
-- array replace
select
	array_replace(array[8,9,10,11,12],10,22)
...
select 
	string_to_array('1,2,3,4,5, ',',',null)
...
(
	'Ankita', array['9089786756','9887766554']
)

insert into teachers(name, phones) values
('Seema', '{"9877665542"}'),
('Julie','{"7867564536","8767567687"}')
